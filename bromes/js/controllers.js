function MainCtrl($window,$rootScope,$scope,$http) {
    ...
    if(typeof sessionStorage.name != 'undefined' && url_now == "/bromes/#/login"){
        $rootScope.session_name = sessionStorage.name;
        $rootScope.session_no = sessionStorage.no;
        $window.location.href = "/bromes/#/dashboards";
    }

    else if(typeof sessionStorage.name == 'undefined'){
        $window.location.href = "/bromes/#/login";
    }
